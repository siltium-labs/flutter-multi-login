...
class AuthManager {
  ...
  Future<UserCredential?> signInWithGoogle() async {
    try {
      ...
      user = await _auth.signInWithCredential(googleOAuthCredential);
      return user;
    } on FirebaseAuthException catch (e) {
  ...
  Future<UserCredential?> signInWithFacebook() async {
    try {
      ...
      // Once signed in, return the UserCredential (inicio de sesion)
      user = await _auth.signInWithCredential(facebookOAuthCredential);
      return user;
    } on FirebaseAuthException catch (e) {
      await onFirebaseAuthException(error: e);
      return null;
  ...
  Future<UserCredential?> signInWithApple() async {
    try {
      ...
      user = await _auth.signInWithCredential(appleOAuthCredential);
      return user;
    } on FirebaseAuthException catch (e) {
      await onFirebaseAuthException(error: e);
      return null;
